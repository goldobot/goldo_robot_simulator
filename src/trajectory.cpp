...
int TrajectoryBuffer::num_segments() const
{
...
float TrajectoryBuffer::min_parameter() const
{
	return m_knot_parameters[m_current_first_index];
}

float TrajectoryBuffer::max_parameter() const
{
	return m_knot_parameters[m_current_last_index];
}
