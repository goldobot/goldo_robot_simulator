...
uint16_t SimpleOdometry::leftEncoderValue() const noexcept
{
	return m_left_encoder;
}

uint16_t SimpleOdometry::rightEncoderValue() const noexcept
{
	return m_right_encoder;
}

const RobotPose& SimpleOdometry::pose() const noexcept
{
	return m_pose;
}
const OdometryConfig& SimpleOdometry::config() const noexcept
{
	return m_config;
}
